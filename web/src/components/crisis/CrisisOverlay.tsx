          ...
          {HOTLINES.map((hotline, idx) => (
            <div key={idx} className="bg-surface-container/40 backdrop-blur-md rounded-card p-5 flex flex-col sm:flex-row items-center justify-between shadow-sm border border-outline-variant/35 hover:border-outline-variant/50 transition-colors">
              ...
              <motion.a 
                ...
                className="bg-gemini-blue text-white ps-5 pe-5 py-2.5 rounded-full font-mono font-medium text-sm hover:bg-gemini-blue-hover transition-colors duration-200 shadow-sm shrink-0 flex items-center justify-center gap-1.5 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gemini-blue focus-visible:ring-offset-2 focus-visible:ring-offset-surface-container"
              >
