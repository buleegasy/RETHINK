      ...
      return (
        <div className="flex flex-col items-center justify-center p-6 bg-red-500/10 rounded-2xl border border-red-500/20 backdrop-blur-md">
          ...
          <button 
            ...
            className="px-4 py-2 bg-red-500/20 hover:bg-red-500/30 text-red-300 rounded-full transition-colors text-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-400/50"
          >
            返回文字模式
          </button>
        </div>
