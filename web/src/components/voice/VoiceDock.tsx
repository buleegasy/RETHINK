      ...
      <div className="pointer-events-auto flex flex-col items-center relative z-10">
        ...
        <motion.div layout transition={SPRING_TRANSITION} className="flex items-center gap-6 mt-6">
          <motion.button
            ...
            className="px-6 py-2.5 bg-red-500/10 text-red-400 hover:bg-red-500/20 hover:text-red-300 transition-colors rounded-full font-medium shadow-[0_0_15px_rgba(239,68,68,0.1)] backdrop-blur-md border border-red-500/20 relative overflow-hidden group focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/50"
          >
            {/* Shimmer effect */}
          ...
          <motion.button
            ...
            className="px-6 py-2.5 bg-gray-800/40 text-gray-300 hover:bg-gray-700/60 transition-colors rounded-full font-medium shadow-[0_0_15px_rgba(255,255,255,0.05)] backdrop-blur-md border border-white/10 relative overflow-hidden group focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/50"
          >
            <div className="absolute inset-0 -translate-x-full group-hover:animate-[shimmer_1.5s_infinite] bg-gradient-to-r from-transparent via-white/10 to-transparent" />
            文字模式
          </motion.button>
