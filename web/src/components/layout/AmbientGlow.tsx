...
export const AmbientGlow: React.FC = () => {
  ...
  // Extract latest emotion from AI response directly from the store
  // This targeted selector prevents AmbientGlow from re-rendering
  // on every stream chunk by extracting only the techChain reference
