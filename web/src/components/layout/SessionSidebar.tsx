                ...
                {user && (
                  <div className="w-full flex items-center justify-between">
                    ...
                    <motion.button 
                      ...
                      whileTap={{ scale: 0.95 }}
                      onClick={logout} 
                      className="text-[11px] tracking-wide text-on-surface hover:text-error transition-colors cursor-pointer px-3 py-1 bg-surface-container/50 hover:bg-error/10 border border-outline-variant/30 rounded-full shrink-0 focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-error"
                    >
                      退出
                    </motion.button>
                  </div>
