        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          >
            ...
            <div className="w-full md:w-1/2 p-4 sm:p-8 md:p-10 lg:p-12 relative flex flex-col justify-center">
              ...
              {error && (
                <div role="alert" className="mb-5 bg-error-container/80 border border-error/20 text-error text-[13px] px-4 py-3 rounded-2xl flex items-start gap-2.5 animate-slide-up shadow-sm">
                  <svg aria-hidden="true" className="w-4 h-4 mt-0.5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2.5">
